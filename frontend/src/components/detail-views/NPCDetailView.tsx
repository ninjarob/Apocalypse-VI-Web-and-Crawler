...
import { NPC, NPCEquipment, NPCSpell, NPCDialogue, NPCPath, NPCSpawnInfo, NPCFlag, NPCFlagInstance } from '@shared/types';
import { api } from '../../api';
...
export function NPCDetailView({ item: selectedNPC, onBack: handleBackToNPCs }: NPCDetailViewProps) {
  ...
  return (
    <div className="detail-view-container">
      <BackButton onClick={handleBackToNPCs} label="← Back to NPCs" />
