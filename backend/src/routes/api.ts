...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    if (from_room_id && type === 'room_exits') {filters.from_room_id = parseInt(from_room_id as string);}
    if (direction && type === 'room_exits') {filters.direction = direction as string;}
