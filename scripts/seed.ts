...
function seedData() {
  ...
  const zones = [
    ...
    { id: 2, name: 'Midgaard: City', alias: 'Midgaard: City', description: 'The city of Midgaard is the center of economic trade, commerce, and travel throughout the imperial realm. Shops, guilds, inns and more line the various streets of the city, catering to citizens and adventurers alike. Although it is not the political capital of his majesty the emperor\'s kingdom, it has nonetheless stood as a pillar of the known world since the dawning of the current age.', author: 'Original DIKU Team, Pestilence, Nero', difficulty: 1, notes: null },
    { id: 3, name: 'Midgaard: Graveyard', alias: 'Midgaard: Graveyard', description: 'Beyond Midgaard\'s southern gates lies the graveyard. For years the Gravekeeper has kept the place that honors Midgaard\'s fallen pristine. But now an evil lurks below the crypts, causing zombies to rise up to threaten and wreak havoc upon the beloved city.', author: 'Nero', difficulty: 1, notes: null },
    { id: 4, name: 'Midgaard: Sewers', alias: 'Midgaard: Sewers', description: 'Deep beneath the sleepless city of Midgaard lurks a world unseen by the eyes of most travelers. Here is where the thieves and murderers of Midgaard go to escape the eyes of the law, and where the rats which frequent the city by day and night call home.', author: 'Nero', difficulty: 2, notes: null },
    { id: 5, name: 'Training Grounds', alias: 'Training Grounds', description: 'The Training Grounds is an excellent place for adventurers to begin their quest towards becoming a legend within the realm.', author: 'Alucard, Nero', difficulty: 1, notes: null },
    { id: 6, name: 'Quester\'s Enclave', alias: 'Quester\'s Enclave', description: 'Set within the heart of Midgaard, the Quester\'s Enclave serves players who have distinguished themselves through the acquisition of quest points. Beyond this, quester\'s also hosts a variety of arena events which are typically opened for a limited time, or on a seasonal basis.', author: 'Sapphire', difficulty: 5, notes: null },
    ...
    { id: 9, name: 'The Hills of Astyll', alias: 'Astyll Hills', description: 'The Hills of Astyll blanket the land north of Midgaard. They provide a buffer between the peaceful city and the harsh mountains farther to the north and east. Beware the rampaging raiders that have taken their home in the Hills, and of the various creatures lurking within the cave.', author: 'Finger, Sapphire', difficulty: 1, notes: null },
    { id: 10, name: 'The Shire', alias: 'The Shire', description: 'The Shire is north of Midgaard, beyond the Hills of Astyll. Here is where the quiet halfling folk call their home. While the Thain maintains the Shire to extend safety to all travelers and adventurers alike, most residents would rather see the quaint landscape of their village remain unvisited by the outside world.', author: 'Elflord, Nero, Sapphire', difficulty: 2, notes: null },
    { id: 12, name: 'The Haunted Forest', alias: 'Haunted Forest', description: 'Rumors run in numbers about the dark, oppressive woods to the East of Midgaard. Lumberjacks fear to enter, telling tales of a variety of wicked creatures that inhabit the dark woods. Some even go as far as to call the woods haunted.', author: 'Prometheus, Alucard, Nero', difficulty: 2, notes: null },
    ...
    { id: 19, name: 'The Forest of Haon-Dor', alias: 'Forest of Haon-Dor', description: 'To Forest of Haon-Dor may be found directly to the west of the City of Midgaard. Wolves, arachnids, and other foul creatures lurk beneath the thick canopy which prevents the sun from reaching the forest floor.', author: 'Quifael, Wolverine, Nero', difficulty: 3, notes: null },
    ...
    { id: 30, name: 'Camelot', alias: 'King Arthur\'s Castle, Camelot', description: 'Beyond the river south of Midgaard lies the castle Camelot, home to King Arthur and the Knights of the Round Table. Troubadours and minstrels from across the realms have gathered to entertain at the great feast.', author: 'Wibble, Werm', difficulty: 3, notes: null },
    ...
    { id: 40, name: 'The Canticle', alias: 'The Canticle', description: 'North of the Shire lies the Canticle, a fortress which was once controlled by knights, paladins, mages, and clerics who fought in the imperial army.', author: 'Tiera, ElfLord, Sapphire', difficulty: 2, notes: null },
    ...
    { id: 47, name: 'Juris', alias: 'Juris, The City of Law', description: 'Centuries ago, the city of Juris lay on a razor\'s edge between civilization and the vast, unexplored eastern frontier. After years of tragedy, the citizens established a system of justice unrivaled even in the imperial courts.', author: 'Ratboy, Sapphire', difficulty: 3, notes: null },
  ...
  const insertZone = db.prepare('INSERT INTO zones (id, name, alias, description, author, difficulty, notes) VALUES (?, ?, ?, ?, ?, ?, ?)');

  zones.forEach(zone => {
    insertZone.run(zone.id, zone.name, zone.alias, zone.description, zone.author, zone.difficulty, zone.notes);
  });
  ...
  const zoneConnections = [
    ...
    { zone_id: 2, connected_zone_id: 3, connection_type: 'adjacent', description: 'Southern city gates lead to the graveyard' },
    { zone_id: 2, connected_zone_id: 4, connection_type: 'adjacent', description: 'Sewers accessible beneath the city streets' },
    { zone_id: 2, connected_zone_id: 5, connection_type: 'adjacent', description: 'Training grounds north of the city' },
    { zone_id: 2, connected_zone_id: 6, connection_type: 'adjacent', description: 'Quester\'s Enclave within the city center' },
    { zone_id: 2, connected_zone_id: 7, connection_type: 'ocean', description: 'Coastal access to the Great Ocean' },
    { zone_id: 2, connected_zone_id: 8, connection_type: 'mountain_pass', description: 'Mountain pass through the Candlebriar Mountains' },
    { zone_id: 2, connected_zone_id: 9, connection_type: 'adjacent', description: 'Northern hills bordering the city' },
    { zone_id: 2, connected_zone_id: 12, connection_type: 'adjacent', description: 'Eastern forest bordering the city outskirts' },
    { zone_id: 2, connected_zone_id: 13, connection_type: 'adjacent', description: 'Western road to Rome' },
    { zone_id: 2, connected_zone_id: 14, connection_type: 'adjacent', description: 'Hidden sanctuary within the city' },
    { zone_id: 2, connected_zone_id: 17, connection_type: 'adjacent', description: 'Temple complex in southern Midgaard' },
    { zone_id: 2, connected_zone_id: 21, connection_type: 'adjacent', description: 'Eastern desert bordering the city' },
    { zone_id: 2, connected_zone_id: 32, connection_type: 'adjacent', description: 'College of Wizardry in the city' },
    // Zone 3 - Midgaard: Graveyard
    { zone_id: 3, connected_zone_id: 2, connection_type: 'adjacent', description: 'Northern path back to Midgaard city' },
    { zone_id: 3, connected_zone_id: 5, connection_type: 'adjacent', description: 'Western trail to training grounds' },
    // Zone 4 - Midgaard: Sewers
    { zone_id: 4, connected_zone_id: 2, connection_type: 'adjacent', description: 'City streets above the sewers' },
    { zone_id: 4, connected_zone_id: 63, connection_type: 'adjacent', description: 'Underground passages to the Underworld' },
    // Zone 5 - Training Grounds
    { zone_id: 5, connected_zone_id: 2, connection_type: 'adjacent', description: 'Southern path to Midgaard city' },
    { zone_id: 5, connected_zone_id: 3, connection_type: 'adjacent', description: 'Eastern path to the graveyard' },
    // Zone 6 - Quester's Enclave
    { zone_id: 6, connected_zone_id: 2, connection_type: 'adjacent', description: 'Exit back to Midgaard city' },
    // Zone 7 - The Great Ocean (connects to many coastal zones)
    { zone_id: 7, connected_zone_id: 2, connection_type: 'ocean', description: 'Midgaard\'s coastal harbor' },
    { zone_id: 7, connected_zone_id: 8, connection_type: 'ocean', description: 'Coastal waters along the Candlebriar Mountains' },
    { zone_id: 7, connected_zone_id: 19, connection_type: 'ocean', description: 'Western coastal access to Haon-Dor' },
    { zone_id: 7, connected_zone_id: 25, connection_type: 'ocean', description: 'Northern waters to Fae\'Rune' },
    { zone_id: 7, connected_zone_id: 26, connection_type: 'ocean', description: 'Northern waters to Fae\'Rune mainland' },
    { zone_id: 7, connected_zone_id: 30, connection_type: 'ocean', description: 'Southern waters to Camelot' },
    { zone_id: 7, connected_zone_id: 36, connection_type: 'ocean', description: 'Ghost ship sails these waters' },
    { zone_id: 7, connected_zone_id: 37, connection_type: 'ocean', description: 'Coastal access to the Black Market' },
    { zone_id: 7, connected_zone_id: 38, connection_type: 'ocean', description: 'Pirate stronghold on the coast' },
    { zone_id: 7, connected_zone_id: 42, connection_type: 'ocean', description: 'Western waters to Tuatha de Danaan' },
    { zone_id: 7, connected_zone_id: 48, connection_type: 'ocean', description: 'Southern waters to Raddok' },
    { zone_id: 7, connected_zone_id: 60, connection_type: 'ocean', description: 'Western waters to the Forbidden Empire' },
    { zone_id: 7, connected_zone_id: 65, connection_type: 'ocean', description: 'Western waters to the Blightlands' },
    { zone_id: 7, connected_zone_id: 74, connection_type: 'ocean', description: 'Burning Talon pirate ship' },
    // Zone 8 - The Candlebriar Mountains
    { zone_id: 8, connected_zone_id: 2, connection_type: 'mountain_pass', description: 'Southern pass to Midgaard' },
    { zone_id: 8, connected_zone_id: 7, connection_type: 'ocean', description: 'Eastern coastal access' },
    { zone_id: 8, connected_zone_id: 19, connection_type: 'adjacent', description: 'Western border with Haon-Dor forest' },
    { zone_id: 8, connected_zone_id: 48, connection_type: 'mountain_pass', description: 'Southern pass to Raddok' },
    // Zone 9 - The Hills of Astyll
    { zone_id: 9, connected_zone_id: 2, connection_type: 'adjacent', description: 'Southern border with Midgaard' },
    { zone_id: 9, connected_zone_id: 10, connection_type: 'adjacent', description: 'Northern path to the Shire' },
    { zone_id: 9, connected_zone_id: 11, connection_type: 'adjacent', description: 'Northeastern dwarven kingdom' },
    { zone_id: 9, connected_zone_id: 12, connection_type: 'adjacent', description: 'Eastern haunted forest' },
    { zone_id: 9, connected_zone_id: 31, connection_type: 'mountain_pass', description: 'Northeastern Mountain of Hate' },
    { zone_id: 9, connected_zone_id: 33, connection_type: 'adjacent', description: 'Northern Lord Vrolok\'s Estate' },
    { zone_id: 9, connected_zone_id: 40, connection_type: 'adjacent', description: 'Eastern Canticle fortress' },
    { zone_id: 9, connected_zone_id: 44, connection_type: 'adjacent', description: 'Western goblin caves' },
    { zone_id: 9, connected_zone_id: 49, connection_type: 'adjacent', description: 'Northeastern Aurvuron' },
    { zone_id: 9, connected_zone_id: 56, connection_type: 'adjacent', description: 'Northeastern Gardens of the Arcane' },
    { zone_id: 9, connected_zone_id: 61, connection_type: 'adjacent', description: 'Northern King Fredrick\'s Forest' },
    // Zone 10 - The Shire
    { zone_id: 10, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern hills of Astyll' },
    { zone_id: 10, connected_zone_id: 40, connection_type: 'adjacent', description: 'Northern Canticle' },
    { zone_id: 10, connected_zone_id: 45, connection_type: 'adjacent', description: 'Eastern Imladris' },
    { zone_id: 10, connected_zone_id: 49, connection_type: 'adjacent', description: 'Northeastern Aurvuron' },
    // Zone 11 - The Dwarven Kingdom
    { zone_id: 11, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern hills of Astyll' },
    { zone_id: 11, connected_zone_id: 31, connection_type: 'mountain_pass', description: 'Northern Mountain of Hate' },
    // Zone 12 - The Haunted Forest
    { zone_id: 12, connected_zone_id: 2, connection_type: 'adjacent', description: 'Western border with Midgaard' },
    { zone_id: 12, connected_zone_id: 8, connection_type: 'adjacent', description: 'Western Candlebriar Mountains' },
    { zone_id: 12, connected_zone_id: 9, connection_type: 'adjacent', description: 'Northern hills of Astyll' },
    { zone_id: 12, connected_zone_id: 21, connection_type: 'adjacent', description: 'Eastern Great Eastern Desert' },
    { zone_id: 12, connected_zone_id: 28, connection_type: 'adjacent', description: 'Northern Pixie Glade' },
    { zone_id: 12, connected_zone_id: 34, connection_type: 'adjacent', description: 'Northern Lady\'s Manor' },
    // Zone 13 - Rome
    { zone_id: 13, connected_zone_id: 2, connection_type: 'adjacent', description: 'Eastern road from Midgaard' },
    { zone_id: 13, connected_zone_id: 43, connection_type: 'adjacent', description: 'Northern Temple of Mars' },
    { zone_id: 13, connected_zone_id: 46, connection_type: 'adjacent', description: 'Western Vault' },
    // Zone 14 - Sanctuary of the Kris
    { zone_id: 14, connected_zone_id: 2, connection_type: 'adjacent', description: 'Hidden within Midgaard city' },
    // Zone 15 - The Village of Bonne Terre
    { zone_id: 15, connected_zone_id: 16, connection_type: 'adjacent', description: 'Northern outskirts' },
    { zone_id: 15, connected_zone_id: 29, connection_type: 'adjacent', description: 'Southern Nottingham' },
    { zone_id: 15, connected_zone_id: 30, connection_type: 'adjacent', description: 'Eastern Camelot' },
    // Zone 16 - The Outskirts of Bonne Terre
    { zone_id: 16, connected_zone_id: 15, connection_type: 'adjacent', description: 'Southern village' },
    // Zone 17 - Temple of Opulence
    { zone_id: 17, connected_zone_id: 2, connection_type: 'adjacent', description: 'Southern Midgaard temple district' },
    // Zone 18 - The Great Battle
    { zone_id: 18, connected_zone_id: 33, connection_type: 'adjacent', description: 'Northern Lord Vrolok\'s Estate' },
    { zone_id: 18, connected_zone_id: 64, connection_type: 'adjacent', description: 'Northern Mortimer\'s Mountain' },
    // Zone 19 - The Forest of Haon-Dor
    { zone_id: 19, connected_zone_id: 7, connection_type: 'ocean', description: 'Western coastal access' },
    { zone_id: 19, connected_zone_id: 8, connection_type: 'adjacent', description: 'Eastern Candlebriar Mountains' },
    { zone_id: 19, connected_zone_id: 37, connection_type: 'adjacent', description: 'Western Black Market' },
    { zone_id: 19, connected_zone_id: 39, connection_type: 'adjacent', description: 'Southern Sylvan Swamp' },
    { zone_id: 19, connected_zone_id: 48, connection_type: 'adjacent', description: 'Eastern Raddok' },
    { zone_id: 19, connected_zone_id: 54, connection_type: 'adjacent', description: 'Northern Mistaavi\'s Mansion' },
    { zone_id: 19, connected_zone_id: 57, connection_type: 'adjacent', description: 'Northern Keep of Mahn-Tor' },
    // Zone 20 - Heliopolis
    { zone_id: 20, connected_zone_id: 21, connection_type: 'adjacent', description: 'Western Great Eastern Desert' },
    { zone_id: 20, connected_zone_id: 22, connection_type: 'adjacent', description: 'Northern Crypt of Nyarlathotep' },
    { zone_id: 20, connected_zone_id: 52, connection_type: 'adjacent', description: 'Southern Thalos ruins' },
    { zone_id: 20, connected_zone_id: 69, connection_type: 'adjacent', description: 'Northern Valley of the Kings' },
    // Zone 21 - The Great Eastern Desert
    { zone_id: 21, connected_zone_id: 2, connection_type: 'adjacent', description: 'Western border with Midgaard' },
    { zone_id: 21, connected_zone_id: 12, connection_type: 'adjacent', description: 'Western Haunted Forest' },
    { zone_id: 21, connected_zone_id: 20, connection_type: 'adjacent', description: 'Eastern Heliopolis' },
    { zone_id: 21, connected_zone_id: 27, connection_type: 'adjacent', description: 'Eastern Cube cavern' },
    { zone_id: 21, connected_zone_id: 47, connection_type: 'adjacent', description: 'Northern Juris' },
    { zone_id: 21, connected_zone_id: 52, connection_type: 'adjacent', description: 'Eastern Thalos' },
    // Zone 22 - The Crypt of Nyarlathotep
    { zone_id: 22, connected_zone_id: 20, connection_type: 'adjacent', description: 'Southern Heliopolis' },
    // Zone 23 - Darkrime Mountain
    { zone_id: 23, connected_zone_id: 47, connection_type: 'mountain_pass', description: 'Southern Juris' },
    { zone_id: 23, connected_zone_id: 73, connection_type: 'adjacent', description: 'Northern Shadow Brotherhood' },
    // Zone 24 - The Kingdom of Arachnos
    { zone_id: 24, connected_zone_id: 39, connection_type: 'adjacent', description: 'Northern Sylvan Swamp' },
    { zone_id: 24, connected_zone_id: 68, connection_type: 'adjacent', description: 'Eastern Sylvan Jungle' },
    // Zone 25 - The Frozen Wasteland of Fae'Rune
    { zone_id: 25, connected_zone_id: 7, connection_type: 'ocean', description: 'Southern Great Ocean' },
    { zone_id: 25, connected_zone_id: 26, connection_type: 'adjacent', description: 'Northern Fae\'Rune mainland' },
    { zone_id: 25, connected_zone_id: 35, connection_type: 'adjacent', description: 'Eastern Valley of Heroes' },
    // Zone 26 - Fae'Rune
    { zone_id: 26, connected_zone_id: 7, connection_type: 'ocean', description: 'Southern Great Ocean' },
    { zone_id: 26, connected_zone_id: 25, connection_type: 'adjacent', description: 'Southern frozen wasteland' },
    // Zone 27 - The Cube
    { zone_id: 27, connected_zone_id: 21, connection_type: 'adjacent', description: 'Western Great Eastern Desert' },
    // Zone 28 - Pixie Glade
    { zone_id: 28, connected_zone_id: 12, connection_type: 'adjacent', description: 'Southern Haunted Forest' },
    // Zone 29 - Nottingham
    { zone_id: 29, connected_zone_id: 15, connection_type: 'adjacent', description: 'Northern Bonne Terre' },
    { zone_id: 29, connected_zone_id: 30, connection_type: 'adjacent', description: 'Eastern Camelot' },
    // Zone 30 - Camelot
    { zone_id: 30, connected_zone_id: 7, connection_type: 'ocean', description: 'Southern Great Ocean' },
    { zone_id: 30, connected_zone_id: 15, connection_type: 'adjacent', description: 'Western Bonne Terre' },
    { zone_id: 30, connected_zone_id: 29, connection_type: 'adjacent', description: 'Western Nottingham' },
    // Zone 31 - Mountain of Hate
    { zone_id: 31, connected_zone_id: 9, connection_type: 'mountain_pass', description: 'Southern Hills of Astyll' },
    { zone_id: 31, connected_zone_id: 11, connection_type: 'mountain_pass', description: 'Southern Dwarven Kingdom' },
    { zone_id: 31, connected_zone_id: 44, connection_type: 'adjacent', description: 'Western Caves of the Goblin King' },
    // Zone 32 - The College of Wizardry
    { zone_id: 32, connected_zone_id: 2, connection_type: 'adjacent', description: 'Within Midgaard city' },
    // Zone 33 - Lord Vrolok's Estate
    { zone_id: 33, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern Hills of Astyll' },
    { zone_id: 33, connected_zone_id: 18, connection_type: 'adjacent', description: 'Southern Great Battle' },
    { zone_id: 33, connected_zone_id: 64, connection_type: 'adjacent', description: 'Northern Mortimer\'s Mountain' },
    // Zone 34 - The Lady's Manor
    { zone_id: 34, connected_zone_id: 12, connection_type: 'adjacent', description: 'Southern Haunted Forest' },
    // Zone 35 - The Valley of Heroes
    { zone_id: 35, connected_zone_id: 25, connection_type: 'adjacent', description: 'Western frozen wasteland' },
    // Zone 36 - The Burning Talon
    { zone_id: 36, connected_zone_id: 7, connection_type: 'ocean', description: 'Sails the Great Ocean' },
    { zone_id: 36, connected_zone_id: 74, connection_type: 'ocean', description: 'Nearby Duke and Duchess ship' },
    // Zone 37 - The Black Market
    { zone_id: 37, connected_zone_id: 7, connection_type: 'ocean', description: 'Coastal harbor' },
    { zone_id: 37, connected_zone_id: 19, connection_type: 'adjacent', description: 'Eastern Forest of Haon-Dor' },
    { zone_id: 37, connected_zone_id: 38, connection_type: 'adjacent', description: 'Northern Pirate\'s Stronghold' },
    // Zone 38 - Pirate's Stronghold
    { zone_id: 38, connected_zone_id: 7, connection_type: 'ocean', description: 'Coastal stronghold' },
    { zone_id: 38, connected_zone_id: 37, connection_type: 'adjacent', description: 'Southern Black Market' },
    // Zone 39 - Sylvan Swamp and City
    { zone_id: 39, connected_zone_id: 19, connection_type: 'adjacent', description: 'Northern Forest of Haon-Dor' },
    { zone_id: 39, connected_zone_id: 24, connection_type: 'adjacent', description: 'Southern Kingdom of Arachnos' },
    { zone_id: 39, connected_zone_id: 68, connection_type: 'adjacent', description: 'Eastern Sylvan Jungle' },
    // Zone 40 - The Canticle
    { zone_id: 40, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern Hills of Astyll' },
    { zone_id: 40, connected_zone_id: 10, connection_type: 'adjacent', description: 'Southern Shire' },
    // Zone 41 - Ashefall Fortress
    { zone_id: 41, connected_zone_id: 47, connection_type: 'adjacent', description: 'Western Juris' },
    // Zone 42 - Tuatha de Danaan
    { zone_id: 42, connected_zone_id: 7, connection_type: 'ocean', description: 'Island in the Great Ocean' },
    // Zone 43 - Temple of Mars
    { zone_id: 43, connected_zone_id: 13, connection_type: 'adjacent', description: 'Southern Rome' },
    // Zone 44 - Caves of the Goblin King
    { zone_id: 44, connected_zone_id: 9, connection_type: 'adjacent', description: 'Eastern Hills of Astyll' },
    { zone_id: 44, connected_zone_id: 31, connection_type: 'adjacent', description: 'Eastern Mountain of Hate' },
    // Zone 45 - Imladris
    { zone_id: 45, connected_zone_id: 10, connection_type: 'adjacent', description: 'Western Shire' },
    // Zone 46 - The Vault
    { zone_id: 46, connected_zone_id: 13, connection_type: 'adjacent', description: 'Eastern Rome' },
    // Zone 47 - Juris
    { zone_id: 47, connected_zone_id: 21, connection_type: 'adjacent', description: 'Southern Great Eastern Desert' },
    { zone_id: 47, connected_zone_id: 23, connection_type: 'mountain_pass', description: 'Northern Darkrime Mountain' },
    { zone_id: 47, connected_zone_id: 41, connection_type: 'adjacent', description: 'Eastern Ashefall Fortress' },
    // Zone 48 - Raddok
    { zone_id: 48, connected_zone_id: 7, connection_type: 'ocean', description: 'Coastal city on the Great Ocean' },
    { zone_id: 48, connected_zone_id: 8, connection_type: 'mountain_pass', description: 'Western Candlebriar Mountains' },
    { zone_id: 48, connected_zone_id: 19, connection_type: 'adjacent', description: 'Western Forest of Haon-Dor' },
    { zone_id: 48, connected_zone_id: 51, connection_type: 'adjacent', description: 'Northern Caves of Fire' },
    { zone_id: 48, connected_zone_id: 53, connection_type: 'adjacent', description: 'Northern Harrington' },
    // Zone 49 - Aurvuron
    { zone_id: 49, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern Hills of Astyll' },
    { zone_id: 49, connected_zone_id: 10, connection_type: 'adjacent', description: 'Southern Shire' },
    { zone_id: 49, connected_zone_id: 45, connection_type: 'adjacent', description: 'Western Imladris' },
    { zone_id: 49, connected_zone_id: 50, connection_type: 'adjacent', description: 'Northern Gray Citadel' },
    // Zone 50 - Aurvuron: The Gray Citadel
    { zone_id: 50, connected_zone_id: 49, connection_type: 'adjacent', description: 'Below the floating citadel' },
    // Zone 51 - The Caves of Fire
    { zone_id: 51, connected_zone_id: 48, connection_type: 'adjacent', description: 'Southern Raddok' },
    // Zone 52 - Thalos
    { zone_id: 52, connected_zone_id: 20, connection_type: 'adjacent', description: 'Western Heliopolis' },
    { zone_id: 52, connected_zone_id: 21, connection_type: 'adjacent', description: 'Western Great Eastern Desert' },
    // Zone 53 - Harrington
    { zone_id: 53, connected_zone_id: 48, connection_type: 'adjacent', description: 'Southern Raddok' },
    { zone_id: 53, connected_zone_id: 61, connection_type: 'adjacent', description: 'Western King Fredrick\'s Forest' },
    { zone_id: 53, connected_zone_id: 62, connection_type: 'adjacent', description: 'Western King Fredrick\'s Castle' },
    // Zone 54 - Mistaavi's Mansion
    { zone_id: 54, connected_zone_id: 19, connection_type: 'adjacent', description: 'Southern Forest of Haon-Dor' },
    { zone_id: 54, connected_zone_id: 61, connection_type: 'adjacent', description: 'Eastern King Fredrick\'s Forest' },
    { zone_id: 54, connected_zone_id: 62, connection_type: 'adjacent', description: 'Eastern King Fredrick\'s Castle' },
    // Zone 55 - Nexus
    { zone_id: 55, connected_zone_id: 65, connection_type: 'portal', description: 'Portal to the Blightlands' },
    // Zone 56 - Gardens of the Arcane
    { zone_id: 56, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern Hills of Astyll' },
    // Zone 57 - The Keep of Mahn-Tor
    { zone_id: 57, connected_zone_id: 19, connection_type: 'adjacent', description: 'Southern Forest of Haon-Dor' },
    { zone_id: 57, connected_zone_id: 58, connection_type: 'adjacent', description: 'Northern Tombs of Tarin' },
    // Zone 58 - The Tombs of Tarin
    { zone_id: 58, connected_zone_id: 57, connection_type: 'adjacent', description: 'Southern Keep of Mahn-Tor' },
    { zone_id: 58, connected_zone_id: 59, connection_type: 'adjacent', description: 'Northern Gnomelight Village' },
    // Zone 59 - Gnomelight Village and Mines
    { zone_id: 59, connected_zone_id: 58, connection_type: 'adjacent', description: 'Southern Tombs of Tarin' },
    // Zone 60 - The Forbidden Empire
    { zone_id: 60, connected_zone_id: 7, connection_type: 'ocean', description: 'Western Great Ocean access' },
    // Zone 61 - King Fredrick's Forest
    { zone_id: 61, connected_zone_id: 9, connection_type: 'adjacent', description: 'Southern Hills of Astyll' },
    { zone_id: 61, connected_zone_id: 53, connection_type: 'adjacent', description: 'Eastern Harrington' },
    { zone_id: 61, connected_zone_id: 54, connection_type: 'adjacent', description: 'Eastern Mistaavi\'s Mansion' },
    { zone_id: 61, connected_zone_id: 62, connection_type: 'adjacent', description: 'Northern King Fredrick\'s Castle' },
    // Zone 62 - King Fredrick's Castle
    { zone_id: 62, connected_zone_id: 53, connection_type: 'adjacent', description: 'Western Harrington' },
    { zone_id: 62, connected_zone_id: 54, connection_type: 'adjacent', description: 'Western Mistaavi\'s Mansion' },
    { zone_id: 62, connected_zone_id: 61, connection_type: 'adjacent', description: 'Southern King Fredrick\'s Forest' },
    // Zone 63 - Underworld
    { zone_id: 63, connected_zone_id: 4, connection_type: 'adjacent', description: 'Above in Midgaard Sewers' },
    // Zone 64 - Mortimer's Mountain
    { zone_id: 64, connected_zone_id: 18, connection_type: 'adjacent', description: 'Southern Great Battle' },
    { zone_id: 64, connected_zone_id: 33, connection_type: 'adjacent', description: 'Southern Lord Vrolok\'s Estate' },
    // Zone 65 - The Blightlands
    { zone_id: 65, connected_zone_id: 7, connection_type: 'ocean', description: 'Western coastal access' },
    { zone_id: 65, connected_zone_id: 55, connection_type: 'portal', description: 'Portal from the Nexus' },
    { zone_id: 65, connected_zone_id: 66, connection_type: 'adjacent', description: 'Eastern Land of Nature\'s Descent' },
    { zone_id: 65, connected_zone_id: 71, connection_type: 'adjacent', description: 'Northern Caves of Ice' },
    // Zone 66 - The Land of Nature's Descent
    { zone_id: 66, connected_zone_id: 65, connection_type: 'adjacent', description: 'Western Blightlands' },
    { zone_id: 66, connected_zone_id: 67, connection_type: 'adjacent', description: 'Eastern Plane of the All-Devourer' },
    // Zone 67 - Plane of the All-Devourer
    { zone_id: 67, connected_zone_id: 66, connection_type: 'adjacent', description: 'Western Land of Nature\'s Descent' },
    // Zone 68 - The Sylvan Jungle
    { zone_id: 68, connected_zone_id: 24, connection_type: 'adjacent', description: 'Western Kingdom of Arachnos' },
    { zone_id: 68, connected_zone_id: 39, connection_type: 'adjacent', description: 'Western Sylvan Swamp' },
    // Zone 69 - Valley of the Kings
    { zone_id: 69, connected_zone_id: 20, connection_type: 'adjacent', description: 'Southern Heliopolis' },
    // Zone 70 - Tales of Treasure (quest area - general access)
    { zone_id: 70, connected_zone_id: 2, connection_type: 'quest', description: 'Quest access from Midgaard' },
    // Zone 71 - Caves of Ice
    { zone_id: 71, connected_zone_id: 65, connection_type: 'adjacent', description: 'Southern Blightlands' },
    // Zone 72 - Mechandar: The Eternal Clock
    { zone_id: 72, connected_zone_id: 2, connection_type: 'portal', description: 'Portal from Midgaard' },
    // Zone 73 - The Shadow Brotherhood
    { zone_id: 73, connected_zone_id: 23, connection_type: 'adjacent', description: 'Southern Darkrime Mountain' },
    // Zone 74 - The Duke and Duchess
    { zone_id: 74, connected_zone_id: 7, connection_type: 'ocean', description: 'Sails the Great Ocean' },
    { zone_id: 74, connected_zone_id: 36, connection_type: 'ocean', description: 'Nearby Burning Talon ship' }
  ];

  const insertZoneConnection = db.prepare('INSERT INTO zone_connections (zone_id, connected_zone_id, connection_type, description) VALUES (?, ?, ?, ?)');

  zoneConnections.forEach(conn => {
    insertZoneConnection.run(conn.zone_id, conn.connected_zone_id, conn.connection_type, conn.description);
  });
